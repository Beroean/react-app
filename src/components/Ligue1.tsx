...
function Ligue1(props: ILigue1) {
  ...
  async function loadCompetetionData() {
    const standingsData = await footballService.getFrenchStandings();
    const scorersData = await footballService.getFrenchScorers();
...
interface ILigue1 extends WithStyles<typeof styles> {}

export default withStyles(styles)(Ligue1);
